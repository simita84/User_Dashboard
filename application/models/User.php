...
Class User extends CI_model
{
   ...
   else if($input_validation_passed)
   {
       $insert_query  =  "INSERT INTO  users
                           (first_name,last_name,email,users.password,user_level,
       ...
       $add_user = $this->db->query($insert_query,
          ...
          if( $add_user )
          {
             ...
             $data["success_message"] = "Successfully registered with Dojo.Please login with your 
                                         credentials";
          }
          else
          {    
              $data["user_created"] = FALSE;
              $data["error_message"] = "Cant create user.DB error";
          }      
      }
